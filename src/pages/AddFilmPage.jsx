...
import { Button, FileUpload, Field, Flex, Grid, Heading, Input, Checkbox, CheckboxGroup, Text, Textarea, Fieldset, FieldErrorText, Box} from "@chakra-ui/react";
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Flex direction={"column"} ml="201px" w={"785px"}  borderWidth={"1px"} borderColor={"#DEE2E6"} pl={"60px"} pt={"60px"} pb={"60px"} pr={"116px"} rounded={"20px"} gap={"20px"}>
                    ...
                    <Flex justify={"center"}>
                        <Button type="submit" variant={"solid"} colorPalette="blue" w={"145px"} h={"48px"}>Добавить фильм</Button>
                    </Flex>
            </Flex>           
            </Flex>
        </form>
